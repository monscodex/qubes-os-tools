...
def get_name_of_templatevm_of_vm(vm_name: str) -> str:
...
def get_front_window_id() -> Union[str, None]:
...
def get_vm_name_with_window_id(window_id: str) -> str:
...
def get_output_of_system_command(command: str) -> str:
